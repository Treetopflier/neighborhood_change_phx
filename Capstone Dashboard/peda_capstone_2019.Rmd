...
This dashboard identifies five demographic changes to consider:
...
### % Houses for Sale 2000 and 2010

```{r, figure.align="center", figure.height = 10, figure.width=10}
hist(vacancy.dashboard$VacantForSale_2000,col=rgb(250,128,114, alpha=100, maxColorValue = 250), 
xlab="Houses for Sale",main="Histograms for\n Houses for Sale in 2000 and 2010", breaks=50)
hist(vacancy.dashboard$VacantForSale_2010, col=rgb(255,127,80, alpha=50, maxColorValue = 255), add=TRUE, breaks=50)
legend( "right", legend= c("Houses 2000", "Houses 2010"), fill=c("lightsalmon", rgb(255,127,80, alpha=50, maxColorValue = 255)),  box.lty=2, box.col="black")
```
...
race.pop.2010.mod <- read.csv("https://raw.githubusercontent.com/Treetopflier/neighborhood_change_phx/master/Written%20CSVs/race_2010_pop.csv")

# race.pop.2010.mod <- read.csv("/home/anthony/Documents/Capstone/Solo Project/Written CSVs/race_2010_pop.csv")
...
combined <- tracts( state="AZ", county="Maricopa", cb=TRUE, year=2015 )
combined <- merge( phx, race.pop.2010.mod, by.x="TRACTCE", by.y="tract" )

phx_dorling <- spTransform( combined, CRS("+init=epsg:3395") )
...
Population Cartograms {data-orientation=rows}
=====================================    
...
phx2_dorling <- spTransform( combined, CRS("+init=epsg:3395") )
...
tm_basemap( "Stamen.Watercolor" ) +
  tm_shape( phx_dorling, bbox=bb ) + 
  tm_polygons( col="POP", n=7, style="quantile", palette="-inferno" ) 
...
Unemployed Cartograms {data-orientation=rows}
=====================================    

### Unemployed Cartograms

```{r, results='hide'}
phx3_dorling <- spTransform( combined, CRS("+init=epsg:3395") )
...
tm_shape( phx_dorling, bbox=bb ) + 
  tm_polygons( col="punemp12", n=10, style="quantile", palette="Spectral" ) +
  tm_layout( "Dorling Cartogram", title.position=c("right","top") )

tmap_mode("plot")
tm_basemap( "Stamen.Watercolor" ) +
  tm_shape( phx_dorling, bbox=bb ) + 
  tm_polygons( col="punemp12", n=7, style="quantile", palette="-inferno" ) 
```
