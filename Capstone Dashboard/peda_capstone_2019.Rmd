...
* College Degree in 2010
  + Those who obtained a 4 year college degree were selected because of the impact it has on the community. Specifically, this dashboard looks at dorlan cartograms to identify the percent of the population with four year degrees in Maricopa county.
...
College Cartograms {data-orientation=rows}
=====================================    
...
tm_shape( phx_dorling, bbox=bb ) + 
  tm_polygons( col="pcol12", n=10, style="quantile", palette="Spectral" ) +
  tm_layout( "Dorling Cartogram", title.position=c("right","top") )

tmap_mode("plot")
tm_basemap( "Stamen.Watercolor" ) +
  tm_shape( phx_dorling, bbox=bb ) + 
  tm_polygons( col="pcol12", n=7, style="quantile", palette="-inferno" ) 
```
